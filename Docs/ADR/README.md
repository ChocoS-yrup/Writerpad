...
| ADR | 결정 | 상태 |
|---|---|---|
| [ADR-001](ADR-001-local-scope.md) | 로컬 1~7단계 범위와 AI·플롯 고정 기능 제외 | 승인 |
| [ADR-002](ADR-002-txt-source-of-truth.md) | UTF-8 TXT를 본문 단일 원본으로 사용 | 승인 |
| [ADR-003](ADR-003-stable-document-identity.md) | UUID 문서 정체성과 상대 경로 분리 | 승인 |
| [ADR-004](ADR-004-defer-server-contract.md) | Windows v2 확정 전 서버 계약을 보류 | 승인 |
